...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.editEquation.setStatusTip(_translate("MainWindow", "f(x, t)"))
        ...
        self.editInitialCondition.setStatusTip(_translate("MainWindow", "self explained in label!, :p"))
        ...
        self.editSolutionInterval.setStatusTip(_translate("MainWindow", "[x0, x1, x2,..., xN]"))
        ...
        self.cbActivationFunction.setStatusTip(_translate("MainWindow", "which activation function to use"))
        ...
        self.cbOptimizer.setStatusTip(_translate("MainWindow", "which optimization method to use"))
        ...
        self.editIterations.setStatusTip(_translate("MainWindow", "number of epochs of the training"))
        ...
        self.editNeurons.setStatusTip(_translate("MainWindow", "amount of neurons in the hidden layer"))
        self.editNeurons.setText(_translate("MainWindow", "5"))
        self.editNeurons.setPlaceholderText(_translate("MainWindow", "5"))
        self.lbAccuracy.setText(_translate("MainWindow", "Accuracy:"))
        self.editAccuracy.setStatusTip(_translate("MainWindow", "solution precision"))
        ...
        self.cbPlotSolution.setStatusTip(_translate("MainWindow", "whatever to show a graphical solution or not"))
        self.cbPlotSolution.setText(_translate("MainWindow", "Plot Solution"))
        self.cbPlotLoss.setStatusTip(_translate("MainWindow", "whatever to show the loss vs. epoch history or not"))
